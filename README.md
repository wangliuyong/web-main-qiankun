...
├── kids-drawing-client/ # 儿童绘画启蒙 uni-app Vue3（H5 / 微信小程序 / APP，端口 5176）
└── doc/                 # PRD 与技术方案
```
...
## 儿童绘画启蒙 uni-app（kids-drawing-client）

面向 3–8 岁儿童的绘画启蒙应用，技术栈：**uni-app Vue3 + TypeScript + Pinia + Vite CLI**，本地存储进度与作品，`api/` 层预留 nest-server 云同步。
...
```bash
cd kids-drawing-client && pnpm install
...
|------|-------------------|---------------------|
| 引擎 | uni-app Vue3 + Vite CLI | uni-app Vue3 + Vite CLI |
